  ...
  methods: {
    ...
    submitForm(event) {
      ...
      const newItem = {
        price: form.price,
        rooms: {
          bedrooms: form.rooms.bedrooms,
          bathrooms: form.rooms.bathrooms,
        },
        location: {
          street: form.location.street,
          houseNumber: form.location.houseNumber,
          houseNumberAddition: form.location.houseNumberAddition,
      ...
      this.addPost(newItem);
      this.openCardPage(newItem);
    },
